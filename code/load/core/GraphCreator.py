...
class GraphCreator:
    def __init__(self, mySQLHandler:MySQLHandler, virtuosoHandler:VirtuosoHandler, kg_files_directory:str="./../kg_files"):
    ...
    def create_triplet_in_SQL(self, subject, predicate, object, extraction_info):
        ...
        if triplet_id_df.empty:
            ...
            triplet_id = self.mySQLHandler.insert('Triplet', {'subject': subject_json, 'predicate': predicate_json, 'object': object_json})
