...
def initialize_extractor() -> AI4LifeExtractor:
    """
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--num-models", type=int, default=20, help="Number of models to download"
    )
    parser.add_argument(
        "--output-dir",
...
def main():
    ...
    extractor = initialize_extractor(args.num_models)
    end_time = time.time()
