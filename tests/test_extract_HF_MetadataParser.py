...
class TestMetadataParser:
    ...
    def parser(self) -> MetadataParser:
        ...
        parser = MetadataParser(
            qa_model="Intel/dynamic_tinybert", path_to_config_data="./config_data"
        )
        return parser

    def add_base_questions(
        self, df: pd.DataFrame, parser: MetadataParser
    ) -> pd.DataFrame:
        """
    ...
    def test_add_default_extraction_info(self, parser: MetadataParser) -> None:
        ...
        # Call the function
        info_dict = parser.add_default_extraction_info(
        ...
        assert info_dict == {
            ...
            "extraction_time": info_dict["extraction_time"],
        }
    ...
    def test_parse_known_fields_HF(self, parser: MetadataParser) -> None:
        ...
        data = {
            "modelId": [
                "nelson2424/gptj6b-FAQ-NelsMarketplace",
                "nelson2424/gptj6b-FAQ-NelsMarketplace",
            ],
            "author": ["a1", "a2"],
            "createdAt": ["c1", "c2"],
