...
class TestGraphCreator:
    ...
    def setup_mock_graph_creator(self) -> GraphCreator:
        ...
        graph_creator = GraphCreator(mock_mySQLHandler,
    ...
    @pytest.fixture
    def setup_graph_creator(self,setup_mysql_handler,setup_virtuoso_handler) -> GraphCreator:
        #Initializing the database handlers
        graph_creator = GraphCreator(setup_mysql_handler,
    ...
    def test_triplet_deprecation(self, setup_graph_creator: GraphCreator):
        ...
        graph_creator.create_triplet_in_SQL(URIRef("http://example.com/model1"),
        ...
        self.assert_sql_db_state(expected_triplets=1,
                                expected_models=1,
                                expected_ranges=1,
        ...
        self.assert_sql_db_state(expected_triplets=2,
                                expected_models=1,
                                expected_ranges=2,
                                expected_extraction_info=1,
