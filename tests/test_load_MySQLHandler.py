...
class TestLMySQLHandler:
    ...
    def my_sql_handler(self):
        return MySQLHandler(host='mysql', user='test_user', password='test_pass', database='test_DB')
    ...
    def test_load_graph_to_mysql_mock(self, my_sql_handler, mocker):
        ...
        my_sql_handler.insert(table='test_triples',
                              data={"subject": 'http://example.org/subject', "predicate": 'http://example.org/predicate', "object": 'object'})
