...
class TestFileProcessor:
    ...
    @pytest.fixture
    def setup_file_processor(
        self, mocker, request, tmp_path
    ) -> Tuple[QueueObserver, FilesProcessor, str]:
        """
    ...
    @pytest.fixture
    def setup_file_processor_with_files(
    ...
    def create_files_for_batch_processing(
        self,
        test_dir: str,
        wait_for_response: float,
        files_to_create: int,
        start_file_num: int,
        logger,
    ) -> List[str]:
    ...
    def wait_for_next_batch_processing(
        self,
        file_processor: FilesProcessor,
        logger,
        waiting_period: int,
    ...
    def check_files_got_processed(
        self, file_paths: List[str], file_processor: FilesProcessor
    ):
        processed = True
    ...
    def test_add_file_adds_tsv_files(
        self, setup_file_processor: Tuple[QueueObserver, FilesProcessor, str]
    ) -> None:
        """
    ...
    @pytest.mark.fixture_data(3, 2)
    def test_add_file_adds_json_files(
        self, setup_file_processor: Tuple[QueueObserver, FilesProcessor, str]
    ) -> None:
        """
        Test that adding a file adds it to the files_to_proc list
    ...
    @pytest.mark.fixture_data(3, 2)
    def test_add_file_same_name_fails(
        self, setup_file_processor: Tuple[QueueObserver, FilesProcessor, str]
    ) -> None:
        """
        Test that adding a file adds it to the files_to_proc list
    ...
    def test_add_file_after_processing_same_name_fails(
        self,
        caplog,
        setup_file_processor: Tuple[QueueObserver, FilesProcessor, str],
        logger,
    ) -> None:
        """
        ...
        # Create files for batch processing and simulate file creation event
        file_paths.extend(
            self.create_files_for_batch_processing(
                test_dir,
    ...
    @pytest.mark.fixture_data(2, 2)
    def test_not_add_file_already_processed(
        self,
        caplog,
        setup_file_processor_with_files: Tuple[QueueObserver, FilesProcessor, str],
        logger,
    ) -> None:
        """
    ...
    @pytest.mark.fixture_data(2, 2)
    def test_creates_workers_on_complete_batch(
        self,
        caplog,
        setup_file_processor: Tuple[QueueObserver, FilesProcessor, str],
        logger,
    ...
    @pytest.mark.fixture_data(2, 2)
    def test_creates_workers_on_multiple_batches(
        self,
        caplog,
        setup_file_processor: Tuple[QueueObserver, FilesProcessor, str],
        logger,
    ...
    def test_creates_workers_after_waiting(
        self,
        caplog,
        setup_file_processor: Tuple[QueueObserver, FilesProcessor, str],
        logger,
        ...
        self.wait_for_next_batch_processing(
            file_processor, logger, waiting_period=10, wait_for_response=0.4
        )
    ...
    def test_creates_workers_after_batch_and_waiting(
        self,
        caplog,
        setup_file_processor: Tuple[QueueObserver, FilesProcessor, str],
        logger,
        ...
        # Wait for next batch processing
        self.wait_for_next_batch_processing(
            file_processor, logger, waiting_period=10, wait_for_response=0.6
        )
    ...
    @pytest.mark.fixture_data(2, 10)
    def test_no_workers_if_no_new_files(
        self,
        caplog,
        setup_file_processor: Tuple[QueueObserver, FilesProcessor, str],
        logger,
        ...
        self.wait_for_next_batch_processing(
            file_processor, logger, waiting_period=5, wait_for_response=0
        )
        ...
        self.wait_for_next_batch_processing(
            file_processor, logger, waiting_period=6, wait_for_response=0
        )
    ...
    @pytest.mark.fixture_data(2, 10)
    def test_waiting_time_goes_down(
        self,
        caplog,
        setup_file_processor: Tuple[QueueObserver, FilesProcessor, str],
        logger,
        ...
        assert (
            file_processor.curr_waiting_time == file_processor.next_batch_proc_time - 5
        )

        self.wait_for_next_batch_processing(
            file_processor, logger, waiting_period=5, wait_for_response=0.4
        )
